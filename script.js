...
const projectsData = {
    riverpark: {
        ...
        description: "Жилой комплекс премиум класса на Кутузовском проспекте. 5 башен-небоскребов, уникальная архитектура от ADM, собственные имена башен: Emerald, Amber, Diamond, Lazur. Первая линия Москвы-реки, рядом парк Фили.",
        work: "Технический заказчик",
        specs: [
            { label: "Площадь квартир (кв.м)", value: "141 550" },
            { label: "Квартир", value: "2012" },
            { label: "Этажей", value: "45-46" }
        ]
    },
    zubovskaya: {
        title: "Гостиница на Зубовской площади",
        location: "Москва, Зубовская пл., вл.3, стр.1,3",
        status: "Реконструкция завершена",
        description: "Реконструкция нежилого здания на Зубовской площади в Москве. Уникальное сочетание классической архитектуры и современных технологий гостеприимства.",
        work: "Технический заказчик",
        specs: [
            { label: "Категория", value: "4*" },
            { label: "Номеров", value: "150" },
            { label: "Этажей", value: "12" }
        ]
    },
    hirurgiya: {
        title: "Международный центр хирургии и реабилитации",
        location: "Москва, 3-я Черепковская, вл.15-А",
        status: "Завершен",
        description: "Современный медицинский центр с передовым оборудованием. Центр специализируется на сложных хирургических операциях и реабилитации пациентов.",
        work: "Технический заказчик",
        specs: [
            { label: "Этажей", value: "8" },
            { label: "Площадь (кв.м)", value: "20 000" },
            { label: "Коек", value: "200" }
        ]
    },
    kotelnaya: {
        title: "Реконструкция котельной",
        location: "Москва, 3-я Черепковская, вл.15-А",
        status: "Завершен",
        description: "Реконструкция комплекса отопительно-производственной котельной на территории Кардиологического центра.",
        work: "Технический заказчик",
        specs: [
            { label: "Тип", value: "Отопительно-производственная котельная" }
        ]
    },
    "kvartaly-21-19": {
        title: "ЖК 'Кварталы 21/19'",
        location: "Москва, Рязанский проспект, вл. 6А",
        status: "Завершен",
        description: "Многофункциональный жилой комплекс как эталон развития городской среды. Проект спроектирован как единое целое архитектурным бюро 'Цимайло, Ляшенко и партнеры'.",
        work: "Технический заказчик",
        specs: [
            { label: "Площадь (кв.м)", value: "---" }
        ]
    },
    lime: {
        title: "ЖК 'Лайм'",
        location: "Москва, район Алексеевский",
        status: "Завершен",
        description: "Жилой комплекс бизнес-класса с привлекательным архитектурным решением и внутренними двориками.",
        work: "Технический заказчик",
        specs: [
    ...
    "aero-city": {
        title: "Бизнес центр AERO City",
        location: "Москва, Куркинское шоссе, стр. 2",
        status: "Завершен",
        description: "Деловой комплекс переменной этажности от 6 до 27 этажей, расположен в районе Бутаковского залива.",
        work: "Технический заказчик",
        specs: [
            { label: "Этажей", value: "6-27" }
        ]
    },
    gazprom: {
        title: "Комплекс зданий 'Газпромбанка'",
        location: "Москва, Новочеремушкинская, вл. 63",
        status: "Завершен",
        description: "Эффектный и продуманный до мелочей деловой центр класса A+ для Газпромбанка.",
        work: "Технический заказчик",
        specs: [
            { label: "Класс", value: "A+" },
            { label: "Этажей", value: "25" },
            { label: "Площадь (кв.м)", value: "50 000" }
        ]
    },
    sportmaster: {
        ...
        location: "Москва",
        status: "Завершен",
        description: "Корпоративные офисы для ведущих спортивных и fashion брендов России.",
        work: "Технический заказчик",
        specs: [
            { label: "Этажей", value: "15" },
            { label: "Площадь (кв.м)", value: "30 000" }
        ]
    },
    rublevka: {
        title: "Деловой центр на Рублевском шоссе",
        location: "Московская область, Рублево-Успенское шоссе",
        status: "Завершен",
        description: "Деловой центр класса В+ в престижном районе Московской области, 55 300 кв.м.",
        work: "Технический заказчик",
        specs: [
            { label: "Класс", value: "B+" },
            { label: "Площадь (кв.м)", value: "55 300" }
        ]
    },
    "stratos-lab": {
        title: "Научно-деловой центр STRATOS LAB",
        location: "Москва, Юго-Западный округ",
        status: "Завершен",
        description: "Деловой центр класса А, общей площадью 44 000 кв.м., расположен в престижном деловом районе на Юго-Западе Москвы.",
        work: "Технический заказчик",
        specs: [
            { label: "Класс", value: "A" },
            { label: "Площадь (кв.м)", value: "44 000" }
        ]
    },
    kozikhinskiy: {
        title: "Жилой дом в Большом Козихинском переулке",
        location: "Москва, Большой Козихинский пер.",
        status: "Завершен",
        description: "Современный жилой дом — вклад в архитектурное наследие будущего.",
        work: "Технический заказчик",
        specs: [
            { label: "Тип", value: "Жилой дом" }
        ]
    },
    poklonkaplace: {
        title: "Деловой квартал Poklonka place",
        location: "Москва, ул. Поклонная, д. 3",
        status: "Завершен",
        description: "Деловой квартал класса А, состоящий из пяти зданий разной этажности, рядом с Парком Победы.",
        work: "Технический заказчик",
        specs: [
            { label: "Класс", value: "A" },
            { label: "Зданий", value: "5" }
        ]
    },
    starbeevo: {
        title: "Жилой комплекс 'Старбеево'",
        location: "Московская область, Старбеево",
        status: "Завершен",
        description: "Жилой комплекс комфорт класса, новое строительство. 2 многоквартирных дома с подземной автостоянкой.",
        work: "Технический заказчик",
        specs: [
            { label: "Этажей", value: "6-8" },
            { label: "Площадь (Га)", value: "5,5" }
        ]
    },
    taurus: {
        title: "Бизнес-центр 'Таурус'",
        location: "Москва, ЦАО",
        status: "Завершен",
        description: "Бизнес центр класса А, общей площадью 18 680 кв.м., расположен в Центральном Административном Округе Москвы.",
        work: "Технический заказчик",
        specs: [
            { label: "Класс", value: "A" },
            { label: "Площадь (кв.м)", value: "18 680" }
        ]
    },
    nakhimov: {
        title: "Бизнес-центр 'Нахимов'",
        location: "Москва, пересечение Севастопольского и Нахимовского проспектов",
        status: "Завершен",
        description: "Офисный центр бизнес-класса, 16 417 кв.м., 2 уровня подземной парковки.",
        work: "Технический заказчик",
        specs: [
            { label: "Класс", value: "Бизнес" },
            { label: "Площадь (кв.м)", value: "16 417" }
        ]
    },
    "klub-2071": {
        title: "Коттеджный поселок 'Клуб 20'71'",
        location: "Московская область",
        status: "Завершен",
        description: "Поселок 'Клуб 20'71' расположен в живописном лесу с преобладанием хвойных деревьев. Современная архитектура, высококачественные материалы.",
        work: "Технический заказчик",
        specs: [
            { label: "Тип", value: "Коттеджный поселок" }
        ]
    },
    mkp: {
        title: "ЗАО 'Московская кофейня на паяхъ'",
        location: "Москва",
        status: "Завершен",
        description: "Реконструкция предприятия с целью увеличения производственной мощности на 6 тн/см. сублимированного кофе и 1,1 тн/см. кофейного шлама.",
        work: "Технический заказчик",
        specs: [
            { label: "Тип", value: "Производственное предприятие" }
        ]
    }
};
